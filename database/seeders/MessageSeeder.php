        ...
        Message::withoutEvents(function () {
            $messages = [
                ...
                [
                    ...
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_002_agent_outbound@mail.cadastre.test',
                    'in_reply_to' => 'msg_001_sultan_inbound@mail.cadastre.test',
                ...
                [
                    ...
                    'user_id' => null,
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_003_sultan_reply@mail.cadastre.test',
                    'in_reply_to' => 'msg_002_agent_outbound@mail.cadastre.test',
                    'direction' => MessageDirection::INBOUND,
                ...
                [
                    ...
                    'in_reply_to' => 'msg_003_sultan_reply@mail.cadastre.test',
                    'direction' => MessageDirection::OUTBOUND,
                ...
                [
                    ...
                    'user_id' => null,
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_005_noura_inbound@mail.cadastre.test',
                    'in_reply_to' => null,
                    'direction' => MessageDirection::INBOUND,
                ...
                [
                    ...
                    'user_id' => 4,
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_006_agent_reply@mail.cadastre.test',
                    'in_reply_to' => 'msg_005_noura_inbound@mail.cadastre.test',
                    'direction' => MessageDirection::OUTBOUND,
                ...
                [
                    ...
                    'user_id' => null,
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_008_vance_inbound@mail.cadastre.test',
                    'in_reply_to' => null,
                    'direction' => MessageDirection::INBOUND,
                ...
                [
                    ...
                    'template_id' => 10,
                    'mailbox_message_id' => null,
                    'in_reply_to' => 'msg_008_vance_inbound@mail.cadastre.test',
                    'direction' => MessageDirection::OUTBOUND,
                ...
                [
                    ...
                    'user_id' => null,
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_010_layla_inbound@mail.cadastre.test',
                    'in_reply_to' => null,
                    'direction' => MessageDirection::INBOUND,
                    'body_text' => "Dear Cadastre AI, I am reviewing the Avenue Montaigne Penthouse (€3.6M). We would like to verify the co-ownership charges and whether notary deed signing can be coordinated remotely.",
                    'body_html' => "<p>Dear Cadastre AI,</p><p>I am reviewing the <strong>Avenue Montaigne Penthouse (€3.6M)</strong>. We would like to verify the quarterly co-ownership charges and whether notary deed signing can be coordinated via international power of attorney.</p>",
                    'is_draft' => false,
                    'is_ai_generated' => false,
                    'attachments' => null,
                ...
                [
                    ...
                    'user_id' => 4,
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_011_agent_outbound@mail.cadastre.test',
                    'in_reply_to' => 'msg_010_layla_inbound@mail.cadastre.test',
                    'direction' => MessageDirection::OUTBOUND,
                ...
                [
                    ...
                    'user_id' => null,
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_013_sterling_inbound@mail.cadastre.test',
                    'in_reply_to' => null,
                    'direction' => MessageDirection::INBOUND,
                ...
                [
                    ...
                    'user_id' => 4,
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_014_agent_outbound@mail.cadastre.test',
                    'in_reply_to' => 'msg_013_sterling_inbound@mail.cadastre.test',
                    'direction' => MessageDirection::OUTBOUND,
                ...
                [
                    ...
                    'user_id' => null,
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_015_camille_inbound@mail.cadastre.test',
                    'in_reply_to' => null,
                    'direction' => MessageDirection::INBOUND,
                ...
                [
                    ...
                    'user_id' => 4,
                    'template_id' => null,
                    'mailbox_message_id' => 'msg_016_agent_outbound@mail.cadastre.test',
                    'in_reply_to' => 'msg_015_camille_inbound@mail.cadastre.test',
                    'direction' => MessageDirection::OUTBOUND,
