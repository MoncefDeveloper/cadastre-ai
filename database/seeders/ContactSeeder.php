...
class ContactSeeder extends Seeder
{
    public function run(): void
    {
        $contacts = [
            // =========================================================================
            // 1. UNREAD INCOMING INQUIRIES (IDs 1 - 5)
            // =========================================================================
            [
                'id' => 1,
                'name' => 'Karim Benali',
            ...
            [
                ...
                // 👈 Rebranded to Cadastre AI Enterprise Demo
                'subject' => 'Cadastre AI Enterprise Demo & API Documentation',
