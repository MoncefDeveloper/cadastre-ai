    ...
    */
    ...
    'resources' => [
        ...
        'manage' => [
            ...
            // 1. Reorderable Resources (Add "reorder")
            AiModifierResource::class => [
                'viewAny',
                'view',
                'create',
                'update',
            ...
            // 2. Replicable Resources (Add "replicate")
            ...
            // 3. Read-Only Contacts (Enforce no manual creation or edits)
